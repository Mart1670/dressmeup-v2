 ...
 */
class getHandicapRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HandicapRepository' shared autowired service.
     *
     * @return \App\Repository\HandicapRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HandicapRepository.php';

        return $container->privates['App\\Repository\\HandicapRepository'] = new \App\Repository\HandicapRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
