 ...
 */
class getTagHumeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TagHumeurRepository' shared autowired service.
     *
     * @return \App\Repository\TagHumeurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TagHumeurRepository.php';

        return $container->privates['App\\Repository\\TagHumeurRepository'] = new \App\Repository\TagHumeurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
