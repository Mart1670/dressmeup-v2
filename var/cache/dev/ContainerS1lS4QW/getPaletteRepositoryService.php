 ...
 */
class getPaletteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaletteRepository' shared autowired service.
     *
     * @return \App\Repository\PaletteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaletteRepository.php';

        return $container->privates['App\\Repository\\PaletteRepository'] = new \App\Repository\PaletteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
