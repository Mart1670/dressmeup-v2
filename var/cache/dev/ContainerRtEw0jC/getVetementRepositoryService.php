 ...
 */
class getVetementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VetementRepository' shared autowired service.
     *
     * @return \App\Repository\VetementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VetementRepository.php';

        return $container->privates['App\\Repository\\VetementRepository'] = new \App\Repository\VetementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
