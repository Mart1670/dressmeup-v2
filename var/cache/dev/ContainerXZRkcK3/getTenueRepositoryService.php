 ...
 */
class getTenueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TenueRepository' shared autowired service.
     *
     * @return \App\Repository\TenueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TenueRepository.php';

        return $container->privates['App\\Repository\\TenueRepository'] = new \App\Repository\TenueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
