 ...
 */
class getVetementTagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VetementTagRepository' shared autowired service.
     *
     * @return \App\Repository\VetementTagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VetementTagRepository.php';

        return $container->privates['App\\Repository\\VetementTagRepository'] = new \App\Repository\VetementTagRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
