...
--
-- Host: localhost:3306
-- Generation Time: Dec 18, 2022 at 07:51 PM
...
('DoctrineMigrations\\Version20221218193636', '2022-12-18 19:36:53', 136);
...
--
-- Dumping data for table `palette_color`
--
...
--
-- Dumping data for table `tag_humeur`
--

INSERT INTO `tag_humeur` (`id`, `name`, `category`) VALUES
(1, 'Joyeux', 'Humeur'),
(2, 'Excité', 'Humeur'),
(3, 'Fatigué', 'Humeur'),
(4, 'Festif', 'Humeur'),
(5, 'Casual Friday', 'Humeur'),
(6, 'Comme un lundi', 'Humeur'),
(7, 'Je ne sais pas', 'Humeur'),
(8, 'Décontracté', 'Humeur');
...
(1, NULL, 'Bas', 'Chino', '1-639f6be6a4879.png', 'Chino-Travail-Gris', 1);
